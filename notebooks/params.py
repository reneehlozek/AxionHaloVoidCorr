...
nthreads = 1     # set to the number of CPUs available, more is better
# ================================ #
​
# ========= file handling options ========= #
handle = 'test'  # string to identify the run; used to set filenames
output_folder = 'test'   # /path/to/folder/ where output should be placed
# ========================================= #
​
# ========== cosmology ============ #
...
zobov_buffer = 0.12 #0.08  # fraction of box length overlap between sub-boxes
# -------------------------- #
​
